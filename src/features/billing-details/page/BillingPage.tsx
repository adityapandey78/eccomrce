...
import billingFormProps, { bankEnum, checkoutPayload } from '../types/billingTypes';
          ...
          <Box css={{ width: '500px' }}>
            <Flex flexDirection="column" gap="$10">
              <Box>
                ...
                <FormInput id="firstName" {...register('firstName')} error={errors.firstName?.message} />
              </Box>

              <Box>
                <FormLabel htmlFor="companyName">Company Name</FormLabel>
                <FormInput id="companyName" {...register('companyName')} error={errors.companyName?.message}/>
              </Box>
              ...
              <Box>
                ...
                <FormInput id="addressLine1" {...register('streetAddress')} error={errors.streetAddress?.message} />
              </Box>
              ...
              <Box>
                ...
                <FormInput id="addressLine2" {...register('apartment')} error={errors.apartment?.message} />
              </Box>
              ...
              <Box>
                ...
                <FormInput id="town" {...register('town')}  error={errors.town?.message}/>
              </Box>
              ...
              <Box>
                ...
                <FormInput id="phoneNumber" {...register('phone')} error={errors.phone?.message} />
              </Box>
              ...
              <Box>
                ...
                <FormInput id="email" {...register('email')} error={errors.email?.message} />
              </Box>
              <Controller
                name="saveInfo"
                control={control}
                            ...
                            render={({field:provider})=>(
                                <Flex gap="$8">
                                  <Image
                                    ...
                                    onClick={()=>provider.onChange(bankEnum.bkash)}
                                  />
                                  <Image
                                    src="/Assets/visa.png"
                                    alt="payment-icons"
                                    ...
                                    onClick={()=>provider.onChange(bankEnum.visa)}
                                  />
                                  <Image
                                    ...
                                    onClick={()=>provider.onChange(bankEnum.mastercard)}
                                  />
                                  <Image
                                    ...
                                    onClick={()=>provider.onChange(bankEnum.nagad)}
                                  />
                                </Flex>
