...
import timeDateToMs from '../services/timeDateToMs';
  ...
  <Flex css={{ fontSize: '24px', fontWeight: 'bold', gap: '12px' }}>
    {[
      ...
      <Flex key={idx} >
        ...
        <Text css={{fontSize:'11px',lineHeight:'18px',fontWeight:'$5', textAlign:'start'}}>{label}</Text>
        <Text css={{fontSize:'32px', lineHeight:'30px', letterSpacing:'1px',fontWeight:'$7'}}>{value}</Text>
        </Flex>
        {idx < arr.length - 1 && (
        <Text
          css={{
